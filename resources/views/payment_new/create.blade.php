        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="carrier" placeholder="Enter Carrier">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="amount_due" placeholder="Enter Amount Due">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" step="any" placeholder="0.0" class="form-control" id="new_amount_due" placeholder="Enter New Amount Due">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="new_due_date">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" step="any" placeholder="0.0" class="form-control" id="amount_paid_cc" placeholder="Enter Amount Paid by Credit Card">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" step="any" placeholder="0.0" class="form-control" id="amount_paid_cash" placeholder="Enter Amount Paid in Cash">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" step="any" placeholder="0.0" class="form-control" id="direct_pay" placeholder="Enter Direct Pay Info">
                </div>
            </div>
        </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                ...
                <input type="text" class="form-control" id="cvc1" name="cvc" value="">
            </div>
...
<script>
    $(document).ready(function() {
        $('#policy').on('change', function() {
            ...
            if (policyId) {
                $.ajax({
                    url: '/get-policy-details/' + policyId,
                    type: 'GET',
                    success: function(response) {
                        // Check if the response contains valid data
                        if (response.cvc) {
                            $('#cvc').val(response.cvc);
                            $('#creditCardName').val(response.credit_card_name);
                        } else {
                            alert('No policy details found.');
                        }
                    },
                    error: function(xhr, status, error) {
                        console.log("Error:", xhr.responseText);
                        alert('Failed to fetch policy details. Error: ' + xhr.responseText);
                    }
                });
            } else {
                // Clear the fields if no policy is selected
                $('#cvc').val('');
                $('#creditCardName').val('');
            }
        });
