...
<div class="content-wrapper">
         ...
         <input type="text" hidden value="{{ Auth::user()->name }}" name="agentName" id="agentName"> --}}
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <input type="text" class="form-control" id="policy_number1" name="policy_number1" value="{{ old('policy_number1') }}">
                </div>
    ...
    <div id="searchPolicyDiv" style="display: block">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="policySearch" class="form-label">Search For Which Of Your Policy? </label>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <input type="number" class="form-control" maxlength="3" max="999" id="cvc2" name="cvc2" value="{{ old('cvc2') }}">
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="insured_drivers" class="form-control" id="insuredDrivers" placeholder="Enter number">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="excluded_drivers" class="form-control" id="excludedDrivers" placeholder="Enter number">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="number" class="form-control" id="total_premium" name="total_premium" value="{{ old('total_premium') }}">
                    </div>
        
                    <div class="col-md-4 mb-4">
                        <label for="annual_premium">Annual Premium</label>
                        <input type="number" class="form-control" id="annual_premium" name="annual_premium" value="{{ old('annual_premium') }}">
                    </div>
